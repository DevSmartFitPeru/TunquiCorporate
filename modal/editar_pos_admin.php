<div class="modal fade" id="edit_<?php echo $row['ID_PAGO']; ?>"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="../controlador/editar_pos_admin.php?id=<?php echo $row['ID_PAGO']; ?>" method="post">
  <div class="form-row">
    ...
    <div class="modal-dialog modal-danger">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="../controlador/delete_pos_admin.php?id=<?php echo $row['ID_PAGO']; ?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Si</a>
            </div>
